...
<nav class="navbar navbar-expand-lg navbar-light bg-black text-white px-5">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
            ...
            <li class="nav-item">
                <a class="nav-link active text-white" aria-current="page" href="feedback.php">Feedback</a>
            </li>
        </ul>
